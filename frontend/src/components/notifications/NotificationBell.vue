  ...
  <div class="notification-bell relative">
    ...
    >
      ...
      <div class="px-4 py-3 border-b border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            ...
            <button class="text-gray-400 hover:text-gray-600" @click="toggleDropdown">
      ...
      <div v-else-if="error" class="p-4 text-center">
        ...
        <button class="mt-2 text-blue-600 hover:text-blue-800 text-sm" @click="fetchNotifications">
          Retry
        </button>
      </div>
    ...
    <!-- Backdrop -->
    <div v-if="isDropdownOpen" class="fixed inset-0 z-40" @click="toggleDropdown"></div>
  </div>
</template>
